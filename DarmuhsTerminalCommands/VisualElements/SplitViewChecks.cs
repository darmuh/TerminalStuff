...
internal class SplitViewChecks : MonoBehaviour
{
    ...
    public static void CheckForSplitView(string whatIsIt)
    {
        ...
        {
            Loggers.WARNING($"No matches for CheckForSplitView [ {whatIsIt} ]");
        }
    }
    ...
    private static void SetMiniScreen(string whatIsIt, bool state)
    {
        ...
        Loggers.LogInfo($"{whatIsIt} has set miniscreen to {state}");
    }
    ...
    private static void UpdatePluginInstanceBools(string whatIsIt)
    {
        ...
        switch (whatIsIt)
        {
            ...
            case "map":
                ...
                break;
            case "neither":
                Loggers.LogInfo("whatIsIt - neither, all instance bools reset for views");
                break;
            default:
                Loggers.LogInfo($"Unexpected value for whatIsIt: {whatIsIt}");
                break;
        }
    }
}

...
namespace TerminalStuff.Configs
{
    internal class QoLConfig
    {
        ...
        public static ConfigEntry<bool> TerminalShortcuts { get; internal set; } //adds the bind/unbind keywords and checks for shortcuts on keypress
        public static ConfigEntry<bool> TerminalRunDelay { get; internal set; } //adds both delay related keywords and has coroutine to run the command on a delay
        ...
        public static ConfigEntry<int> TerminalMaxOrderedItems { get; internal set; }
        ...
        internal static void Init()
        {
            ...
            TerminalShortcuts = MakeBool(Plugin.instance.Config, "Quality of Life", "TerminalShortcuts", false, "Enable this for the ability to bind commands to any valid key (also enables the \"bind\" & \"unbind\" keywords.");
            TerminalRunDelay = MakeBool(Plugin.instance.Config, "Quality of Life", "TerminalRunDelay", false, "Enable this for the ability to run commands on a delay, Adds 2 customizable keywords (DelayKWs/StopDelayKWs)");
            ...
            TerminalStartPage = MakeString(Plugin.instance.Config, "Quality of Life", "TerminalStartPage", "Help", "Enter a keyword to load when a player begins using the terminal.\nSet to \"None\" to not load any page!");
            ...
            TerminalMaxOrderedItems = MakeClampedInt(Plugin.instance.Config, "Quality of Life", "TerminalMaxOrderedItems", 12, "Set your desired Max Number of Items that you can order at one time.(capped at 150 for sanity)\nThe vanilla default is 12 and will remain the minimum value for this config item.\nCAUTION: Do not lower this value while loaded into a lobby, may cause crashes/errors", 12, 150);
            ...
            Plugin.Spam("Quality of Life configs section done");
        }
    }
}

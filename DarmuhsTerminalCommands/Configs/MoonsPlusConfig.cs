...
namespace TerminalStuff.SpecialStuff
{
    public class MoonsPlusConfig
    {
        ...
        internal static void Init()
        {
            ...
            ObscureHiddenInfo = MakeBool(Plugin.instance.Config, "MoonsPlus", "ObscureHiddenInfo", false, "When hidden moons are included in the listing, try to obscure info relating to the moon (level reel, ship monitors, etc.)\nRequires Networking to hide for ALL players");
            ...
            RevealHiddenOnRoute = MakeBool(Plugin.instance.Config, "MoonsPlus", "RevealHiddenOnRoute", false, "Decide whether hidden moons should be unhidden after routing to them.\nIf enabled, will unhide moons that you have been to previously.\nRequires networking");
